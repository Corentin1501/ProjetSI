...
GLfloat * rotation_x(GLfloat angle)
{
  ...
  res[4] = (GLfloat)0.0f; // a_12
  res[5] = cos(angle); // a_22
  res[6] = sin(angle); // a_32
  res[7] = (GLfloat)0.0f; // a_42
  
  res[8] = (GLfloat)0.0f; // a_13
  res[9] = -sin(angle); // a_23
  res[10] = cos(angle); // a_33
  res[11] = (GLfloat)0.0f; // a_43
...
GLfloat * rotation_y(GLfloat angle)
{
  ...
  res[0] = cos(angle); // a_11
  res[1] = (GLfloat)0.0f; // a_21
  res[2] = -sin(angle); // a_31
  res[3] = (GLfloat)0.0f; // a_41
...
GLfloat * homotethie(GLfloat x, GLfloat y, GLfloat z){
  ...
  res[0] = (GLfloat)1.0f * x; // a_11
  res[1] = (GLfloat)0.0f; // a_21
  res[2] = (GLfloat)0.0f; // a_31
  res[3] = (GLfloat)0.0f; // a_41
  
  res[4] = (GLfloat)0.0f; // a_12
  res[5] = (GLfloat)1.0f * y; // a_22
  res[6] = (GLfloat)0.0f; // a_32
  res[7] = (GLfloat)0.0f; // a_42
  
  res[8] = (GLfloat)0.0f; // a_13
  res[9] = (GLfloat)0.0f; // a_23
  res[10] = (GLfloat)1.0f * z; // a_33
  res[11] = (GLfloat)0.0f; // a_43
